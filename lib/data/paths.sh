...
: ${DIB_APP_COMPOSE_COMPOSE_TEMPLATE_FILE="$DIB_APP_COMPOSE_DIR/docker-compose.template.yml"}
: ${DIB_APP_COMPOSE_COMPOSE_TEMPLATE_FILE_COPY="${DIB_APP_COMPOSE_COMPOSE_TEMPLATE_FILE}.copy"}
: ${DIB_APP_CONFIG_COMPOSE_TEMPLATE_FILE="$DIB_APP_CONFIG_DIR/docker-compose.template.yml"}
: ${DIB_APP_CONFIG_COMPOSE_TEMPLATE_FILE_COPY="${DIB_APP_CONFIG_COMPOSE_TEMPLATE_FILE}.copy"}
: ${DIB_APP_K8S_ANNOTATIONS_CHANGED_FILE="$DIB_APP_K8S_ANNOTATIONS_DIR/$K8S_RESOURCE_ANNOTATION_TEMPLATE.k8s-annotations.changed"}
: ${DIB_APP_K8S_ANNOTATIONS_CHANGED_FILE_COPY="${DIB_APP_K8S_ANNOTATIONS_CHANGED_FILE}.copy"}
